        ...
        try(DataOutputStream dos = new DataOutputStream(os)){
            ...
            writeCollection(dos, r.getSections().entrySet(), entry ->{
                ...
                switch (type){
                    ...
                    case ACHIEVEMENTS:
                    case QUALIFICATIONS:
                        writeCollection(dos, ((ListSection<String>) section).getItems(), dos::writeUTF);
                        break;
                    case EXPERIENCE:
                    case EDUCATION:
                        writeCollection(dos, ((ListSection<Organization>) section).getItems(), item -> {
                            dos.writeUTF(item.getHomepage().getName());
                            dos.writeUTF(item.getHomepage().getUrl());
                            writeCollection(dos, item.getPositions(), pos -> {
